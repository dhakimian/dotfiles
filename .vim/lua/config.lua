...
local on_attach = function(client, bufnr)
    ...
    -- Allow references to be highlighted through the use of a plugin
...
local servers = { 'intelephense', 'bashls', 'vimls', 'sumneko_lua' }
...
vim.g.Illuminate_ftwhitelist = {'php', 'sh', 'vim', 'lua'}
